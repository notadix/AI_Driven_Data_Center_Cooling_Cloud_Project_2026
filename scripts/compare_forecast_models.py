...
from src.ai.forecast.load_forecaster import LOOKBACK, HORIZON, make_windows  # noqa: E402
...
for h in range(HORIZON):
    ...
    g = HistGradientBoostingRegressor(loss="absolute_error", max_iter=250, learning_rate=0.08, max_depth=5).fit(Ftr, ytr)
